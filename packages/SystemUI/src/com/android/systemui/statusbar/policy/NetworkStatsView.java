    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_NETWORK_STATS), false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL), false, this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.STATUS_BAR_NETWORK_STATS_HIDE), false, this, UserHandle.USER_ALL);
            onChange(true);
        }
        ...
        public void onChange(boolean selfChange) {
            ...
            mActivated = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.STATUS_BAR_NETWORK_STATS, 0, UserHandle.USER_CURRENT) == 1 && networkAvailable;

            mHideOnNoActivity = Settings.System.getIntForUser(mContext.getContentResolver(),
                    Settings.System.STATUS_BAR_NETWORK_STATS_HIDE, 0, UserHandle.USER_CURRENT) == 1;

            mRefreshInterval = Settings.System.getLongForUser(mContext.getContentResolver(),
                    Settings.System.STATUS_BAR_NETWORK_STATS_UPDATE_INTERVAL, 500, UserHandle.USER_CURRENT);
