...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        boolean showOnTheGo = Settings.Nameless.getBooleanForUser(cr,
                Settings.Nameless.POWER_MENU_ONTHEGO_ENABLED, 0, UserHandle.USER_CURRENT) == 1;
        if (showOnTheGo) {
            mItems.add(
    ...
    private void startOnTheGo() { // TODO: its ugly and hacky
