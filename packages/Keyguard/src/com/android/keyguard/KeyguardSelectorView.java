...
import com.android.internal.util.nameless.FlashlighConstants;
...
public class KeyguardSelectorView extends LinearLayout implements KeyguardSecurityView {
    ...
    private void killGlowpadTorch() {
        if (mGlowTorch) {
            ...
            if (mGlowTorchRunning) {
                mGlowTorchRunning = false;
                Intent intent = new Intent(FlashlightConstants.ACTION_OFF);
    ...
    final Runnable checkLongPress = new Runnable () {
        public void run() {
            ...
            Intent intent = new Intent(FlashlightConstants.ACTION_ON);
            mContext.sendBroadcastAsUser(
                    intent, new UserHandle(UserHandle.USER_CURRENT));
        }
    };
