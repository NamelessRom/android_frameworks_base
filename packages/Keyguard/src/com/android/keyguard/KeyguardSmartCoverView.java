...
public class KeyguardSmartCoverView extends LinearLayout {
    ...
    private String getCurrentTemperature() {
        ...
        Cursor c = mContext.getContentResolver().query(
                Uri.parse("content://org.namelessrom.providers.weather/weather/current"),
                projection, null, null, null);
        if (c == null) {
            mFadeInWeather = true;
            mContext.sendBroadcast(new Intent("org.namelessrom.providers.weather.action.action.FORCE_WEATHER_UPDATE"));
