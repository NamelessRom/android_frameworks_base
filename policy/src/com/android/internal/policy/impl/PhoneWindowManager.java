...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    int mHideLockscreenStatusBar = -1;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LOCKSCREEN_HIDE_STATUSBAR), false, this,
                    UserHandle.USER_ALL);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mHideLockscreenStatusBar = Settings.System.getIntForUser(resolver,
                    Settings.System.LOCKSCREEN_HIDE_STATUSBAR, 0, UserHandle.USER_CURRENT);
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        if (mForcingShowNavBar && (win.getSurfaceLayer() < mForcingShowNavBarLayer
            ...
            if (expandedDesktopHidesStatusBar() || mHideLockscreenStatusBar == 1 || mHideLockscreenStatusBar == 3) {
                clearableFlags &= ~View.SYSTEM_UI_FLAG_FULLSCREEN;
            }
            if (expandedDesktopHidesNavigationBar() || mHideLockscreenStatusBar == 2 || mHideLockscreenStatusBar == 3) {
