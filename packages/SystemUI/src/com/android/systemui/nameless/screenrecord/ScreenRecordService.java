...
public class ScreenRecordService extends Service {
    ...
    private void createNotification() {
        ...
        final Intent stopIntent = new Intent(this, TakeScreenrecordService.class)
        ...
        final Intent pointerIntent = new Intent(this, TakeScreenrecordService.class)
    ...
    private void togglePointer(final boolean on) {
        ...
        if (Settings.System.getInt(resolver, Settings.System.SREC_ENABLE_TOUCHES, 0) == 1) {
